...
export function Footer() {
  ...
  return (
    <footer key={locale} className="bg-black">
      ...
      <div className="bg-black text-white py-8">
        <div className="w-full mx-auto px-5 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="text-design-button  text-white">{t('footer.publisherName')}</span>
          </div>

          {/* Right - Social Links and Button */}
      ...
      {/* Opção 1: Hover cinza simples */}
<div className="border-b border-white py-3">
  <div className="container mx-auto px-4 text-center">
    <div className="text-design-button text-white">
      <a href="#" className="hover:text-gray-300 transition-colors duration-300">{t('footer.privacyPolicy')}</a>
      <span className="mx-2">|</span>
      <a href="#" className="hover:text-gray-300 transition-colors duration-300">{t('footer.termsOfUse')}</a>
      <span className="mx-2">|</span>
      <a href="#" className="hover:text-gray-300 transition-colors duration-300">{t('footer.contact')}</a>
    </div>
  </div>
</div>
    </footer>
